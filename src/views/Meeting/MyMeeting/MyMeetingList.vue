...
<script>
import { getMyMeetingList} from "@/apis/mymeeting";
  ...
  data() {
    return {
      ...
      th: [
        ...
        { text: '创建时间', align: 'center', sortable: false, value: 'creatTime' },
  ...
  methods: {
    ...
    toDetail(meeting) {
      ...
      this.$router.push({
        ...
        query: {
          docId: this.meeting.docId,
          participantId: this.meeting.id,
          unit: false,
          mymeeting: true
        }
      })
    ...
    async getMeetingListData() {
      ...
      // 响应界面get
      getMyMeetingList(this.page).then(res => {
